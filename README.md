...
3. **Atualize "credenciais.txt"**: Antes de executar o script, é necessário atualizar o arquivo "credenciais.txt" com as informações de login e senha relevantes. Além disso, forneça os diretórios onde os arquivos serão armazenados após a integração no seu sistema. Essa medida visa evitar o download de arquivos já integrados à nova CMB Unimed. A opção de editar o arquivo de texto é para evitar a necessidade de inserir o login toda vez que você executar o script.
